...
from .scale_and_shift import add_hshift, add_vshift, add_vscale
...
def augment_data(pulse_arr, noise_function, noise_params,
    ...
    '''
    Augments a given set of data.
    Randomly adds noise, a vertical scale,
    a horizontal shift and a vertical shift
    to each pulse.

    Returns clean version (only shifted and scaled)
    and noisy version (same shift and scale).
